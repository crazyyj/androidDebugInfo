 ...
 * 平台 Fragment 蓝色页面。
 */
public class PlatformBlueFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        return inflater.inflate(R.layout.frag_platform_blue, container, false);
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        view.findViewById(R.id.btn_frag_popup_dropdown_show).setOnClickListener(this::showPopupAsDropDown);
    ...
    private void showPopupAsDropDown(View anchor) {
        ...
        title.setText("Blue Fragment Popup");
